    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-md-6 col-lg-3">
            <div class="card my-2 shadow cardPhoto">
                ...
                <div class="card-body">
                    <button type="button" role="button" class="btn btnTfc" data-toggle="modal" aria-label="voir la photo"
                        data-target="#show{{$photo->id}}" title="Voir cette photo"><i class="far fa-eye"></i></button>
                    ...
                    <button type="button" role="button" title="Supprimer le joueur" aria-label="supprimer" class="btn btn-danger"
                        data-toggle="modal" data-target="#ok{{$photo->id}}"><i class="fas fa-times"></i></button>
